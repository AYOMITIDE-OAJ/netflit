...
class TermsConditionsScreenState extends State<TermsConditionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(language!.termsConditions, color: Colors.transparent, textColor: Colors.white, elevation: 0),
      body: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            itemTitle(context, language!.streamTermsConditions).paddingBottom(spacing_standard),
